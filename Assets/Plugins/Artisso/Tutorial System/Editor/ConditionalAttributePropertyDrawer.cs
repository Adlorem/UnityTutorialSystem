...
/// </summary>
[CustomPropertyDrawer(typeof(ConditionalAttributeProperty))]
public class ConditionalAttributePropertyDrawer : PropertyDrawer
{
    #region Fields

    // Reference to the attribute on the property.
    ConditionalAttributeProperty drawIf;
    ...
    {
        if (!ShowMe(property) && drawIf.disablingType == ConditionalAttributeProperty.DisablingType.DontDraw)
        {
    ...
    {
        drawIf = attribute as ConditionalAttributeProperty;
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        else if (drawIf.disablingType == ConditionalAttributeProperty.DisablingType.ReadOnly)
        {
            GUI.enabled = false;
            EditorGUI.PropertyField(position, property, label);
            GUI.enabled = true;
