...
public class ConditionalAttributeProperty : PropertyAttribute
{
    #region Fields
    ...
    public ConditionalAttributeProperty(string comparedPropertyName, object comparedValue, DisablingType disablingType = DisablingType.DontDraw)
    {
